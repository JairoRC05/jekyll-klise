...
function validateForm() {
    ...
    // Validate name input
    if (name === "") {
        document.getElementById("name-error-msg").innerHTML = " Please! TEAM RIVAL";
        return false;
    } else {
    ...
    if (price === "") {
        document.getElementById("price-error-msg").innerHTML = " Please! HORA DEL MATCH";
        return false;
    } else {
    ...
    if (descriptionInput.value.length > 50) {
        ...
        document.getElementById("disc-error-msg").innerHTML = " Please enter the DATE";
        return false;
    } else {
...
function showData() {
    ...
    if (productList.length === 0) {
        ...
        <div class="row gx-2">
          <div class="col">
            <div class="p-3">
              <img src="/assets/backgrounds/NODATAFOUND.png" w class="img-fluid rounded mx-auto d-block w-100" alt="No Products">
            </div>
          </div>
        </div>
      </div>`;
        ...
        <h5 class='card-title text-center'><strong>MATCH No.-</strong> ${element.id} </h5>
        <img src="${element.image}" class="card-img-top " alt='Image' style=" height: 10rem; width: 10rem;">
        </div>
        <ul class='list-group list-group-flush'>
        <li class='list-group-item'><strong>RIVAL -</strong>  ${element.name}  </li>
        <li class='list-group-item h-25'><strong>FECHA -</strong>  ${element.description}  </li>
        <li class='list-group-item'><strong>HORA -</strong>  ${element.price}</li>
        </ul>
...
function AddData() {
    if (validateForm() == true) {
        ...
        alert("MATCH AGREGADO CORRECTAMENTE");
    }
}
...
function searchProduct(sortedItem) {
    ...
    if (sortedItem.length === 0) {
        ...
        <div class="row gx-2">
          <div class="col">
            <div class="p-3">
              <img src="/assets/backgrounds/NODATAFOUND.png" class="img-fluid rounded mx-auto d-block" alt="No Products" style="width: 18rem; height: 18rem;">
        ...
        <img src="${element.image}" class="card-img-top" alt='Image' style=" height: 14rem; width: 14rem;">
        </div>
        <ul class='list-group list-group-flush'>
...
function filteredData(sortedProduct) {
    ...
    if (sortedProduct.length === 0) {
        ...
        <div class="row gx-2">
          <div class="col">
            <div class="p-3">
              <img src="/assets/backgrounds/NODATAFOUND.png" class="img-fluid rounded mx-auto d-block" alt="No Products">
        ...
        <li class='list-group-item'><strong>RIVAL -</strong>  ${element.name}  </li>
        <li class='list-group-item h-25'><strong>FECHA -</strong>  ${element.description}  </li>
        <li class='list-group-item'>HORA -</strong>  ${element.price}</li>
        </ul>
        <div class='card-body text-center'>
         <button onclick='editData("${index}")' type='button' data-bs-toggle='modal' data-bs-target='#exampleModal-2' class='btn btn-success' style="width: 49%">Edit</button>
         <button onclick='deleteData("${index}")' type='button' class='btn btn-danger' style="width: 49%">Delete</button>
